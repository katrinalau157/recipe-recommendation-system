...
/*
  ...
  Widget build(BuildContext context) {
    bool isSaved = savedWords.contains(widget.post.user.name);
    return Column(
      children: <Widget>[
        // User Details
        Row(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: HeartIconAnimator(
                ...
                size: 28.0,
                onTap: _toggleIsLiked(widget.post.user.name),
                triggerAnimationStream: _doubleTapImageEvents.stream,
              ),
            ),
            */
            ...
            IconButton(
              ...
              onPressed: () {
                setState(() {
                if(isSaved){
                  savedWords.remove(widget.post.user.name);
              }else{
                  savedWords.add(widget.post.user.name);
                  lastrecipe = widget.post.user.name;
                  print(lastrecipe);
                }
